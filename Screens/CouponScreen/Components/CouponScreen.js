            ...
            <View style={styles.bg}>
                <View style={styles.header}>
                    ...
                    <View style={styles.headerRight}>
                        <Text style={styles.headerText}>XRPH Prescription Savings Card</Text>
                    ...
                    <Text style={styles.card_id}>{activeAccount.prescription_card.id}</Text>
                    <Text style={styles.card_bin}>{activeAccount.prescription_card.bin}</Text>
                    <Text style={styles.card_group}>{activeAccount.prescription_card.group}</Text>


                    <View style={styles.pharmaWrapper}>
                        <View style={styles.buttonWrapper}>
                            <Feather name={"check"} size={20} color={colors.primary} style={styles.fingerIcon} />
                            <Text style={styles.pharmatext}>XRPH Prescription Savings Card will save you up to 80<Text style={styles.otherChar}>%</Text> on your prescriptions and medications with unlimited use.</Text>
                        </View>
                        <View style={styles.buttonWrapper}>
                            <Feather name={"check"} size={20} color={colors.primary} style={styles.fingerIcon} />
                            <Text style={styles.pharmatext}>Receive XRPH rewards each time your card is used at 68,000+ pharmacies across the US, including CVS, Walgreens, and Walmart.</Text>
                        </View>
