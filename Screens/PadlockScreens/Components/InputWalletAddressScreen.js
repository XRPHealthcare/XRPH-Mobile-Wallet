    ...
    return (
        <View style={styles.bg}>
            <View style={styles.header}>
                ...
                />
                <Text style={styles.sendModalHeaderText}>Connect A Pre-Existing Account</Text>
                <Text style={styles.directionText}>Please enter the wallet address for your account.</Text>
            </View>
            <View style={styles.loadingAnimationWrapper}>
                ...
                <View style={styles.row}>
                    <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('Start Screen')}>
                        <View style={styles.buttonWrapper}>
                            <Feather name={"arrow-left"} size={25} color={colors.text} style={styles.continueIcon} />
                            <Text style={styles.backButtonText}>Back</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.addAccountOkButton} onPress={saveAddresssAndContinue}>
                        <View style={styles.buttonWrapper}>
