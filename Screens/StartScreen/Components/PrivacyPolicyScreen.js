    ...
    return (
        ...
        <StatusBar />
            ...
            <ScrollView contentContainerStyle={styles.webviewWrapper}>
                  ...
                  <WebView source={{ uri: 'https://app.termly.io/document/privacy-policy/009bdc0b-42be-4fa8-932e-b7e233e467f9' }} style={{ height: 1000}} />
              ...
              <TouchableOpacity style={{
                ...
                <View style={{
                  ...
                  height: '100%'
                    ...
                    <Feather name={"check"} size={20} color={checked1 ? '#08F685' : colors.bg} style={styles.fingerIcon} />
                </View>
              </TouchableOpacity>
              <Text style={styles.ppText}>I acknowledge that I have read the Privacy Policy.</Text>
            </View>
            <View style={styles.checkboxContainer}>
                <TouchableOpacity style={{
                    ...
                    <View style={{
                      ...
                      height: '100%'
                        ...
                        <Feather name={"check"} size={20} color={checked2 ? '#08F685' : colors.bg} style={styles.fingerIcon} />
                    </View>
                  </TouchableOpacity>
              <Text style={styles.ppText}>I acknowledge that I agree to the Privacy Policy.</Text>
            </View>
            <View style={styles.slideButtonContainer}>
                  ...
                  <TouchableOpacity style={{
                      backgroundColor: isDisabled ? colors.text_light : colors.secondary,
                      width: '48%',
                      height: 80,
                      alignItems: 'center',
                      ...
                      borderRadius: 20,
                      marginBottom: 10,
                    }} onPress={() => navigation.navigate('Start Screen')} disabled={isDisabled}>
                      <View style={styles.buttonWrapper}>
