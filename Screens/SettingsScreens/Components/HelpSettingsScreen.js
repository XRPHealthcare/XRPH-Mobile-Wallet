            ...
            <View style={styles.bg}>
                ...
                <ScrollView style={styles.settingsWrapper}>
                    ...
                    <View style={styles.setting}>
                        <Text style={styles.settingText}>Email <TouchableOpacity onPress={() => openComposer({to: 'info@xrphealthcare.com'})}><Text style={styles.email}>info@xrphealthcare.com</Text></TouchableOpacity> for questions.</Text>
                    </View>
                    <View style={styles.hl}></View>
                    <View style={styles.setting}>
                        <Text style={styles.settingText}>Join our Discord server for developer questions.</Text>
                    </View>
                    <View style={styles.hl}></View>
                    <View style={styles.setting}>
                            <TouchableOpacity onPress={() => Linking.openURL("https://www.xrphealthcare.com/app-faqs.php")}>
