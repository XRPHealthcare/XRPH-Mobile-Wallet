                ...
                <ScrollView style={styles.settingsWrapper}>
                    ...
                    <View style={styles.setting}>
                        <TouchableOpacity style={styles.setting} onPress={changeTheme}>
                            ...
                            <Feather name={"check"} size={20} color={theme === 'light' ? colors.primary : colors.bg} style={styles.fingerIcon} />
                        </TouchableOpacity>
                        {/* <Switch
                    ...
                    <View style={styles.setting}>
                        <TouchableOpacity style={styles.setting} onPress={changeTheme}>
                            ...
                            <Feather name={"check"} size={20} color={theme === 'dark' ? colors.primary : colors.bg} style={styles.fingerIcon} />
                        </TouchableOpacity>
                        {/* <Switch
                            trackColor={{false: colors.text_light, true: colors.secondary}}
                            thumbColor={colors.text_dark}
