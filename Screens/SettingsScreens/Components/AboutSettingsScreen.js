            ...
            <View style={styles.bg}>
                ...
                <ScrollView style={styles.settingsWrapper}>
                    ...
                    <View style={styles.settingLong}>
                        <Text style={styles.settingTextLong}>The XRP Healthcare Decentralized Mobile Wallet is a non-custodial wallet backed by the XRP Ledger. 
                                                            This gives our users complete control over their wallet - making sure every transaction is completely 
                                                            safe, secure, and anonymous.</Text>
                    </View>
                    <View style={styles.hl}></View>
                    <View style={styles.settingLong}>
                        <Text style={styles.settingTextLong}>The first Pharma and Healthcare platform to be built on the XRP Ledger. XRP Healthcare
                                                            (XRPH) is an innovative, scalable solutions company utilizing Web3 technology to revolutionize the
                                                            way people access and afford healthcare services globally.</Text>
                    </View>
                    <View style={styles.hl}></View>
                </ScrollView>
