...
import {useAddWalletAddressToBook} from '../../../utils/wallet.api';
...
const SaveToAddressBook = props => {
  const bottomSheetRef = useRef(null);
  let {activeAccount, theme} = useStore();
  const saveToAddressBook = useAddWalletAddressToBook();
  ...
  React.useEffect(() => {
    setAddressForm({
      ...addressForm,
      walletAddress: props?.destinationAddress,
    });
            ...
            <View>
              <TouchableOpacity
                ...
                <LinearGradient
                  ...
                  {saveToAddressBook?.isPending ? (
                    <ActivityIndicator size={25} color="#fff" />
                  ) : (
                    <Text style={styles.paymentRequestText}>Save </Text>
                  )}
                </LinearGradient>
              </TouchableOpacity>
            </View>
...
export default SaveToAddressBook;
