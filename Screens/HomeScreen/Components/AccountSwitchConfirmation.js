...
const AccountSwitchConfirmation = props => {
    ...
    <Modal visible={props.isConfirmModal} transparent={true}>
      <View style={styles.addAccountModalWrapper}>
        <View style={styles.sendModalHeader}>
          ...
          <Text style={styles.sendModalHeaderText}>Confirm Switch</Text>
          <TouchableOpacity
        ...
        <View style={styles.addAccountModalActionsWrapper}>
          <Text style={styles.addAccountModalDirections}>
            ...
            Are you sure you want to switch current account
          </Text>
...
export default AccountSwitchConfirmation;
