            ...
            {props.txModalOpen &&
                <View style={styles.addAccountModalWrapper}>
                    <View style={styles.sendModalHeader}>
                        ...
                        <Text style={styles.sendModalHeaderText}>Your Balances Have Been Updated</Text>
                        <TouchableOpacity style={styles.sendModalCloseButton} onPress={() => props.closeTxModal()}>
                    ...
                    <View style={styles.addAccountModalActionsWrapper}>
                        <View style={styles.addAccountActionButtons}>
                            <TouchableOpacity style={styles.addAccountOkButton} onPress={() => props.goToTxHistory()}>
                                <View style={styles.buttonWrapper}>
                                    <Text style={styles.addAccountOkButtonText}>View Transaction</Text>
                                    <Feather name={"arrow-right"} size={20} color={colors.text} style={styles.continueIcon} />
                                </View>
                            </TouchableOpacity>
                        </View>
                    </View>
