...
const useStore = create((set, get) => ({
    ...
    entropy: "",
    setEntropy: (newEntropy) => set(() => ({
        entropy: newEntropy
    })),

    padlockErrorMessage: "",
    setPadlockErrorMessage: (errorMessage) => set(() => ({
        padlockErrorMessage: errorMessage
    })),
    onPadlockSuccess: () => set(() => ({
        padlockErrorMessage: ""
    })),
    onPadlockError: () => set(() => ({
    ...
    accounts: [],
    setAccounts: (updatedAccounts) => set(() => ({
        accounts: updatedAccounts
    })),
    addAccount: (newAccount) => set(() => ({
    ...
    setSendTransactionDetails: (transaction) => set(() => ({
        sendTransactionDetails: transaction
    })),

    destinationAddress: "",
    setDestinationAddress: (address) => set(() => ({
        destinationAddress: address
    })),

    token: {},
    setToken: (selectedToken) => set(() => ({
        token: selectedToken
    })),

    tokenRate: 0,
    setTokenRate: (newRate) => set(() => ({
        tokenRate: newRate
    })),
    ...
    destinationTag: "",
    setDestinationTag: (newTag) => set(() => ({
        destinationTag: newTag
    })),

    rateLoading: false,
    setRateLoading: (bool) => set(() => ({
        rateLoading: bool
    })),

    exchangeTo: "USD",
    setExchangeTo: (to) => set(() => ({
        exchangeTo: to
    })),
    ...
    fromInput: "",
    setFromInput: (input) => set(() => ({
        fromInput: input
    })),

    toInput: "",
    setToInput: (input) => set(() => ({
        toInput: input
    })),
    ...
    theme: 'light',
    toggleTheme: (mode) => set(() => ({
        theme: mode
    })),

    loginWalletAddress: "",
    setLoginWalletAddress: (address) => set(() => ({
        loginWalletAddress: address
    })),

    totalBalanceCurrency: "USD",
    setTotalBalanceCurrency: (newCurrency) => set(() => ({
